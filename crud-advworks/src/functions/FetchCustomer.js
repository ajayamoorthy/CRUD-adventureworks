...
app.http('FetchCustomer', {
    ...
    handler: async (request, context) => {
        ...
        try {
            //connect to database
            await sql.connect("Server=tcp:sqlserver-reactproject.database.windows.net,1433;Initial Catalog=adventureworks-aj;Authentication=Active Directory Default;");
